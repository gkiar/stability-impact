...
\PaperTitle{Numerical Instabilities in Neuroscience Software Leads to Unexpected Variability in Networks} % Article title
...
could severely hamper our understanding of brain organization in brain-imaging studies, it also provides the
opportunity to obtain lower bias estimates of brain structure. This paper highlights the potential of leveraging the
induced variance in estimates of brain connectivity to increase the reliability of datasets alongside the robustness of
their applications in the detection or classification of individual differences. This paper demonstrates that stability
